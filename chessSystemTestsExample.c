...
bool testChessAddTournamentAndEndTournament_maaroof() {
    ...
    ASSERT_TEST(chessSaveTournamentStatistics(sys1, "your_output/test_add_tournament_end_tournament.txt") == CHESS_SUCCESS);
    
    //FILE* f1 = fopen("your_output/test_add_tournament_end_tournament.txt", "r");
...
bool testRemoveTournament_maaroof() 
{
    ...
    ASSERT_TEST(chessSaveTournamentStatistics(sys1,"your_output/test_tournament_remove.txt") == CHESS_NO_TOURNAMENTS_ENDED);

    ASSERT_TEST(chessEndTournament(sys1, 1) == CHESS_SUCCESS);
    ASSERT_TEST(chessSaveTournamentStatistics(sys1, "your_output/test_tournament_remove.txt") == CHESS_SUCCESS);
    FILE* f1 = fopen("your_output/test_tournament_remove.txt", "r");
...
bool oneMoreTestJustYouKnowToMakeSureEveryThingWorksFine_maaroof() {
    ...
    //file_name = "your_output/tour3_add_same_game.txt";
    
    file_name = "your_output/tour2_remove_winner.txt";
    ASSERT_TEST(chessEndTournament(sys1, 2) == CHESS_SUCCESS);
    chessSaveTournamentStatistics(sys1, file_name);
...
bool testPlayerLevelsAdvanced_maaroof() {
    ...
    //ASSERT_TEST(chessRemovePlayer(sys1, player_1) == CHESS_SUCCESS);
    FILE* f = fopen("your_output/test_player_level_advanced.txt", "w");
    ASSERT_TEST(f != NULL);
    ...
    f = fopen("your_output/test_player_level_advanced_after_remove.txt", "w");
    ASSERT_TEST(f != NULL);
    ASSERT_TEST(chessSavePlayersLevels(sys1, f) == CHESS_SUCCESS);
    fclose(f);

    ASSERT_TEST(chessAddGame(sys1, 1, player_1, player_2, FIRST_PLAYER, 3) == CHESS_SUCCESS);
    f = fopen("your_output/test_player_level_advanced_add_same_game.txt", "w");
    ASSERT_TEST(f != NULL);
    ASSERT_TEST(chessSavePlayersLevels(sys1, f) == CHESS_SUCCESS);
    fclose(f);
...
bool testTournamentWinner_maaroof() {
    ...
    f = fopen("your_output/test_player_score_2_after_remove_sys2.txt", "w");
    ASSERT_TEST(f != NULL);
